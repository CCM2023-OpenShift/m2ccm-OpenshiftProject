                            ...
                            <div>
                                <div className="flex items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-900">
                                            {new Date(lastCreatedBooking.startTime!).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' })}
                                            {' - '}
                                            {new Date(lastCreatedBooking.endTime!).toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' })}
                                        </p>
                                    </div>
                                </div>
            ...
            <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8">
                ...
                <div className="mb-8">
                    ...
                    {selectedRoom && (
                        <div className="mb-5 bg-blue-50 p-4 rounded-lg border border-blue-100">
                            ...
                            <p className="mb-2">
                                <span className="font-medium text-gray-700">Capacité:</span> {selectedRoom.capacity} personnes
                            </p>
                                    ...
                                    if (attendees > selectedRoom.capacity) {
                                        ...
                                        return (
                                            <p className="text-blue-600 text-sm flex items-center">
                                                <Info size={14} className="mr-1"/>
                                                Cette salle est peut-être surdimensionnée pour {attendees} personnes.
                                            </p>
                                        );
                                    }
                                    return null;
                ...
                <div className="mb-8">
                    ...
                    {formData.startTime && formData.endTime ? (
                            ...
                            {availableEquipmentsMobile.length > 0 ? (
                                <div className="max-h-64 overflow-y-auto bg-gray-50 rounded-lg p-4">
                                    {availableEquipmentsMobile.map((req) => {
                                        ...
                                        return (
                                            <div key={req.equipmentId} className="flex items-center justify-between mb-3 pb-3 border-b border-gray-200 last:border-0">
                        ...
                        <div className="p-4 bg-yellow-50 border border-yellow-300 text-yellow-800 rounded-lg flex items-start">
                            <AlertCircle className="w-5 h-5 mr-2 flex-shrink-0 mt-0.5" />
                            <p>Veuillez sélectionner une date et des heures pour voir les équipements mobiles disponibles.</p>
                        </div>
                    )}
                </div>
